    ...
    public sealed class DiagnosticsBundle
    {
        ...
        private static object ToDiagnosticMonitor(MonitorInfo monitor)
        {
            return new
            {
                ...
                DxgiColorSpaceName = DxgiColorSpaceInfo.DecodeColorSpace(monitor.DxgiColorSpace),
                monitor.BitsPerColor,
                BitsPerColorName = DxgiColorSpaceInfo.DecodeBitsPerColor(monitor.BitsPerColor),
