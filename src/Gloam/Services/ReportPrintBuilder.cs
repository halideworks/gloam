...
namespace Gloam.Services
{
    ...
    public static class ReportPrintBuilder
    {
        ...
        public sealed record DetailedPrintSection(
            ...
            IReadOnlyList<Gloam.Core.Calibration.PatchDeltaE> WorstPatches,
            IReadOnlyList<Gloam.Core.Calibration.PatchDeltaE> BestPatches,
        ...
        private static void AddPatchTable(
            ...
            IReadOnlyList<Gloam.Core.Calibration.PatchDeltaE> patches)
        {
