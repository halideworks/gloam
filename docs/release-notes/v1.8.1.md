...
- **[Troubleshooting guide](https://github.com/halideworks/gloam/blob/main/docs/troubleshooting.md)**: SmartScreen on install, a profile that
...
- **[Golden fixture contribution guide](https://github.com/halideworks/gloam/blob/main/docs/golden-fixture-contribution.md)**: if you own an
